...
// -------------------------------------------------------
// Portrait Comparison types (T0042)
// Aligned with backend apps/server/src/portrait-comparison/application/types.ts
// -------------------------------------------------------

export interface PortraitComparisonReadiness {
  status: 'ready' | 'not_released';
  contractVersion: string;
  productionPolicyStatus: string;
  capabilities: {
    create: boolean;
    list: boolean;
    detail: boolean;
...
export interface PortraitComparisonSummary {
  readonly id: string;
...
export interface PortraitComparisonDetail {
  readonly id: string;
  readonly mode: ComparisonMode;
  readonly similarityScore: number;
  readonly coverage: number;
...
export interface PortraitComparisonListResponse {
  items: PortraitComparisonSummary[];
  page: {
    cursor: string | null;
    nextCursor: string | null;
    pageSize: number;
...
export interface PortraitComparisonArchiveResult {
